...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.TT: [
        ("0xfb1bffC9d739B8D520DaF37dF666da4C687191EA", 123345319, "1.3.0+L2"),
        ("0x69f4D1788e39c87893C980c06EdF4b7f686e2938", 123345326, "1.3.0"),
    ],
    EthereumNetwork.TST_TESTNET: [
        ("0xfb1bffC9d739B8D520DaF37dF666da4C687191EA", 101511882, "1.3.0+L2"),
        ("0x69f4D1788e39c87893C980c06EdF4b7f686e2938", 101511887, "1.3.0"),
    ],
}
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.TT: [
        ("0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC", 123345267),  # v1.3.0
    ],
    EthereumNetwork.TST_TESTNET : [
        ("0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC", 101511844),  # v1.3.0
    ],
}
